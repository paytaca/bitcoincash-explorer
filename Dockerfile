...
ARG NUXT_PUBLIC_IPFS_GATEWAY=https://ipfs.paytaca.com/ipfs/
ARG NUXT_PUBLIC_PINATA_GATEWAY_TOKEN=
...
ENV NUXT_PUBLIC_IPFS_GATEWAY=${NUXT_PUBLIC_IPFS_GATEWAY}
ENV NUXT_PUBLIC_PINATA_GATEWAY_TOKEN=${NUXT_PUBLIC_PINATA_GATEWAY_TOKEN}
